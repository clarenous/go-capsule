...
func (bk *blockKeeper) blockLocator() []*types.Hash {
...
func (bk *blockKeeper) fastBlockSync(checkPoint *consensus.Checkpoint) error {
	...
	for ; lastHeader.Hash() != checkPoint.Hash; lastHeader = bk.headerList.Back().Value.(*types.BlockHeader) {
		...
		headers, err := bk.requireHeaders([]*types.Hash{&lastHash}, &checkPoint.Hash)
		if err != nil {
			return err
		}
...
func (bk *blockKeeper) locateBlocks(locator []*types.Hash, stopHash *types.Hash) ([]*types.Block, error) {
...
func (bk *blockKeeper) locateHeaders(locator []*types.Hash, stopHash *types.Hash) ([]*types.BlockHeader, error) {
...
func (bk *blockKeeper) requireBlocks(locator []*types.Hash, stopHash *types.Hash) ([]*types.Block, error) {
...
func (bk *blockKeeper) requireHeaders(locator []*types.Hash, stopHash *types.Hash) ([]*types.BlockHeader, error) {
