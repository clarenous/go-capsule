...
func mergeMultiSig(tx *wire.MsgTx, idx int, addresses []common.Address,
...
type KeyDB interface {
	GetKey(common.Address) (*btcec.PrivateKey, bool, error)
}

// KeyClosure implements KeyDB with a closure.
type KeyClosure func(common.Address) (*btcec.PrivateKey, bool, error)
